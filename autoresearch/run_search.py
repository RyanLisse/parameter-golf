...
CONFIG_KEYS = [
    ...
    "GRAD_CLIP_NORM",
    "HASH_INIT_ENABLED",
    "HASH_DROPOUT_ENABLED",
    "HASH_DROPOUT_PCT",
    "CHAOTIC_LR_ENABLED",
    "DIFFICULTY_LR_ENABLED",
    "DIFFICULTY_TARGET_RATE",
    "BONDING_LOSS_ENABLED",
    "BONDING_ALPHA_END",
    "PRUNING_ENABLED",
    "PRUNING_START_RATIO",
    "PRUNING_INTERVAL",
...
SEARCH_CHOICES: dict[str, dict[str, list[str]]] = {
    "cuda": {
        ...
        "MLP_MULT": ["2", "3"],
        "MOE_EXPERTS": ["1", "2", "4", "8"],
        "MOE_DEPLOY_EXPERT": ["-1", "0", "1", "2", "3", "4", "5", "6", "7"],
        ...
        "HASH_INIT_ENABLED": ["0", "1"],
        "HASH_DROPOUT_ENABLED": ["0", "1"],
        "HASH_DROPOUT_PCT": ["5", "10", "15", "20"],
        "CHAOTIC_LR_ENABLED": ["0", "1"],
        "DIFFICULTY_LR_ENABLED": ["0", "1"],
        "DIFFICULTY_TARGET_RATE": ["0.0005", "0.001", "0.002"],
        "BONDING_LOSS_ENABLED": ["0", "1"],
        "BONDING_ALPHA_END": ["0.3", "0.5", "0.7"],
        "PRUNING_ENABLED": ["0", "1"],
        "PRUNING_START_RATIO": ["1.0", "1.1", "1.2"],
        "PRUNING_INTERVAL": ["1000", "2000", "3000"],
        "PRUNING_AMOUNT": ["0.05", "0.10", "0.15"],
        "GAS_OPT_ENABLED": ["0", "1"],
        "GAS_SKIP_DROPOUT_WARMDOWN": ["0", "1"],
        "GAS_FUSE_OPS": ["0", "1"],
        "BFT_ENABLED": ["0", "1"],
        "BFT_TRIM_COUNT": ["1", "2"],
        "DAG_ENABLED": ["0", "1"],
        "DAG_NUM_BRANCHES": ["2", "3", "4"],
        "MERKLE_ENABLED": ["0", "1"],
        "MERKLE_SEGMENT_SIZE": ["32", "64", "128"],
        "SPECTRAL_EMBED_INIT": ["0", "1"],
        "PHASE_TRANSITION_INIT": ["0", "1"],
        "MUON_WD": ["0.0", "0.01", "0.02", "0.03"],
        "EMBED_FP16_PASSTHROUGH": ["0", "1"],
        "EVAL_STRIDE": ["0", "32", "64", "128"],
        "ENSEMBLE_ENABLED": ["0", "1"],
        "DISTILL_TEMP": ["1.0", "2.0", "4.0"],
        "DISTILL_ALPHA": ["0.3", "0.5", "0.7"],
        "CODEBOOK_ENABLED": ["0", "1"],
        "CODEBOOK_BITS": ["4", "6", "8"],
        "CODEBOOK_BLOCK_SIZE": ["1", "2", "4"],
        "PROGRESSIVE_SEQ_ENABLED": ["0", "1"],
        "SEQ_START": ["256", "512", "1024"],
        "SEQ_END": ["1024", "2048", "4096"],
        "SEQ_SCHEDULE": ["linear", "cosine", "step"],
    },
    "mlx": {
...
PRESETS: dict[str, dict[str, dict[str, str]]] = {
    "cuda": {
        ...
        "hash_init": {
            ...
            "TIED_EMBED_INIT_STD": "0.005",
            "HASH_INIT_ENABLED": "1",
            "HASH_DROPOUT_ENABLED": "0",
            "HASH_DROPOUT_PCT": "10",
            "CHAOTIC_LR_ENABLED": "0",
        },
        "moe_shard": {
            "VOCAB_SIZE": "1024",
            "NUM_LAYERS": "9",
        ...
        # Strategy: same as SOTA chase, but disable logit softcap per MLX findings
        "sota_no_softcap": {
            "VOCAB_SIZE": "1024",
            "NUM_LAYERS": "9",
            "MODEL_DIM": "512",
        ...
        # Blockchain-inspired: difficulty-adjusted LR (RJC-33)
        "difficulty_adjusted": {
            "VOCAB_SIZE": "1024",
            "NUM_LAYERS": "10",
            "MODEL_DIM": "512",
            ...
            "TIED_EMBED_INIT_STD": "0.005",
            "GRAD_CLIP_NORM": "0.5",
            "DIFFICULTY_LR_ENABLED": "1",
            "DIFFICULTY_TARGET_RATE": "0.001",
        },
        # DeFi bonding curve token weighting (RJC-35)
        "bonding_curve": {
            "VOCAB_SIZE": "1024",
            "NUM_LAYERS": "9",
            "MODEL_DIM": "512",
            ...
            "WARMDOWN_ITERS": "1200",
            "TIED_EMBED_INIT_STD": "0.005",
            "BONDING_LOSS_ENABLED": "1",
            "BONDING_ALPHA_END": "0.5",
        },
        ...
        "delta_compress": {
            ...
            "VAL_BATCH_SIZE": "524288", "ITERATIONS": "20000",
            "MAX_WALLCLOCK_SECONDS": "600", "TIED_EMBED_LR": "0.05",
            "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
            "MUON_MOMENTUM": "0.95", "MUON_BACKEND_STEPS": "5",
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
        },
        "utxo_prune": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "11", "MODEL_DIM": "576",
            "NUM_HEADS": "9", "NUM_KV_HEADS": "3", "MLP_MULT": "2",
            "TRAIN_SEQ_LEN": "1024", "TRAIN_BATCH_TOKENS": "524288",
            "VAL_BATCH_SIZE": "524288", "ITERATIONS": "20000",
            "MAX_WALLCLOCK_SECONDS": "600", "TIED_EMBED_LR": "0.05",
            "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "PRUNING_ENABLED": "1", "PRUNING_START_RATIO": "1.2",
            "PRUNING_INTERVAL": "2000", "PRUNING_AMOUNT": "0.10",
        },
        "gas_optimized": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "GAS_OPT_ENABLED": "1", "GAS_SKIP_DROPOUT_WARMDOWN": "1",
            "GAS_FUSE_OPS": "1",
        },
        "bft_ensemble": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "BFT_ENABLED": "1", "BFT_TRIM_COUNT": "1",
        },
        "dag_parallel": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "DAG_ENABLED": "1", "DAG_BRANCH_START": "3",
            "DAG_BRANCH_END": "5", "DAG_NUM_BRANCHES": "2",
        },
        "merkle_tree": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "MERKLE_ENABLED": "1", "MERKLE_SEGMENT_SIZE": "64",
            "MERKLE_ALTERNATE": "1",
        },
        # Proven leaderboard techniques from #1 entry (1.1748 val_bpb)
        "championship": {
            ...
            "TIED_EMBED_LR": "0.07", "MATRIX_LR": "0.06", "SCALAR_LR": "0.06",
            "MUON_MOMENTUM": "0.95", "MUON_BACKEND_STEPS": "5",
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "TIED_EMBED_INIT_STD": "0.005", "GRAD_CLIP_NORM": "1.0",
            "SPECTRAL_EMBED_INIT": "1", "SPECTRAL_EXPONENT": "-0.5",
            "PHASE_TRANSITION_INIT": "1", "MUON_WD": "0.02",
            "EMBED_FP16_PASSTHROUGH": "1", "EVAL_STRIDE": "64",
        },
        "championship_longctx": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "10", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            "TRAIN_SEQ_LEN": "4096", "TRAIN_BATCH_TOKENS": "131072",
            "VAL_BATCH_SIZE": "131072", "ITERATIONS": "25000",
            "MAX_WALLCLOCK_SECONDS": "600",
            "WARMDOWN_ITERS": "25000",
            "TIED_EMBED_LR": "0.05", "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
            "MUON_MOMENTUM": "0.99", "MUON_BACKEND_STEPS": "5",
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "TIED_EMBED_INIT_STD": "0.005", "GRAD_CLIP_NORM": "0.3",
            "SPECTRAL_EMBED_INIT": "1", "SPECTRAL_EXPONENT": "-0.5",
            "PHASE_TRANSITION_INIT": "1", "MUON_WD": "0.02",
            "EMBED_FP16_PASSTHROUGH": "1", "EVAL_STRIDE": "64",
        },
        ...
        "codebook_compress": {
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "CODEBOOK_ENABLED": "1", "CODEBOOK_BITS": "6",
            "CODEBOOK_BLOCK_SIZE": "1",
        },
        "progressive_seq": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            ...
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "PROGRESSIVE_SEQ_ENABLED": "1", "SEQ_START": "512",
            "SEQ_END": "2048", "SEQ_SCHEDULE": "linear",
        },
    },
    "mlx": {
        "baseline": {
        ...
        "moe_shard": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "384",
            "NUM_HEADS": "6", "NUM_KV_HEADS": "2", "MLP_MULT": "2",
            "TRAIN_SEQ_LEN": "1024", "TRAIN_BATCH_TOKENS": "8192",
            "VAL_BATCH_SIZE": "8192", "ITERATIONS": "2000",
            "MAX_WALLCLOCK_SECONDS": "180", "TIED_EMBED_LR": "0.05",
            "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
            "MUON_MOMENTUM": "0.95", "MUON_BACKEND_STEPS": "5",
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
            "GRAD_ACCUM_STEPS": "1", "MLX_MAX_MICROBATCH_TOKENS": "8192",
            "MOE_EXPERTS": "4", "MOE_DEPLOY_EXPERT": "-1",
        },
        "delta_compress": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
        ...
        "championship_longctx": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "10", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            "TRAIN_SEQ_LEN": "4096", "TRAIN_BATCH_TOKENS": "8192",
            "VAL_BATCH_SIZE": "8192", "ITERATIONS": "2000",
            "MAX_WALLCLOCK_SECONDS": "180",
            "WARMDOWN_ITERS": "2000",
            "TIED_EMBED_LR": "0.05", "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
        ...
        "progressive_seq": {
            "VOCAB_SIZE": "1024", "NUM_LAYERS": "9", "MODEL_DIM": "512",
            "NUM_HEADS": "8", "NUM_KV_HEADS": "4", "MLP_MULT": "2",
            "TRAIN_BATCH_TOKENS": "8192", "VAL_BATCH_SIZE": "8192",
            "ITERATIONS": "2000", "MAX_WALLCLOCK_SECONDS": "180",
            "TIED_EMBED_LR": "0.05", "MATRIX_LR": "0.04", "SCALAR_LR": "0.04",
            "MUON_MOMENTUM": "0.95", "MUON_BACKEND_STEPS": "5",
            "QK_GAIN_INIT": "1.5", "LOGIT_SOFTCAP": "30.0",
            "WARMDOWN_ITERS": "1200", "TIED_EMBED_INIT_STD": "0.005",
...
def append_result(result: TrialResult) -> None:
    with RESULTS_TSV.open("a", encoding="utf-8") as handle:
        handle.write(
            f"{result.run_id}\t{result.backend}\t{result.mode}\t{result.val_bpb:.8f}\t{result.val_loss:.8f}\t{result.total_bytes}\t{result.status}\t{result.preset}\t{result.code_mutation}\t{','.join(result.parents)}\t{result.train_script_path}\t{result.train_script_bytes}\t{result.quantized_model_bytes}\t{result.model_params}\t{result.elapsed_seconds:.6f}\t{result.log_path}\t{result.description}\n"
        )
